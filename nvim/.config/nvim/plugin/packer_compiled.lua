...
_G.packer_plugins = {
  ...
  ["material.nvim"] = {
    loaded = true,
    path = "/home/matheus/.local/share/nvim/site/pack/packer/start/material.nvim",
    url = "https://github.com/marko-cerovac/material.nvim"
  },
  neon = {
    loaded = true,
    path = "/home/matheus/.local/share/nvim/site/pack/packer/start/neon",
  ...
  ["oceanic-next"] = {
    loaded = true,
    path = "/home/matheus/.local/share/nvim/site/pack/packer/start/oceanic-next",
  ...
  ["popup.nvim"] = {
    loaded = true,
    path = "/home/matheus/.local/share/nvim/site/pack/packer/start/popup.nvim",
